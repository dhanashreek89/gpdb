...
#include "funcapi.h"
	...
	extern List *pg_parse_and_rewrite(const char *query_string, Oid *paramTypes, int iNumParams);
	...
	extern TupleTableSlot *ExecutorRun(QueryDesc *pqueryDesc, ScanDirection direction, long lCount);
