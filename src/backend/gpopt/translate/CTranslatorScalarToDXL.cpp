...
//		Ctor
//---------------------------------------------------------------------------
CTranslatorScalarToDXL::CTranslatorScalarToDXL(IMemoryPool *mp,
...
//---------------------------------------------------------------------------
EdxlBoolExprType
CTranslatorScalarToDXL::EdxlbooltypeFromGPDBBoolType(BoolExprType boolexprtype) const
{
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorScalarToDXL::CreateScalarIdFromVar(const Expr *expr,
											  const CMappingVarColId *var_colid_mapping)
{
	...
	CDXLColRef *dxl_colref = GPOS_NEW(m_mp)
		CDXLColRef(m_mp, mdname, id, GPOS_NEW(m_mp) CMDIdGPDB(var->vartype), var->vartypmod);
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorScalarToDXL::CreateScalarOpFromExpr(const Expr *expr,
											   const CMappingVarColId *var_colid_mapping,
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorScalarToDXL::CreateScalarDistCmpFromDistExpr(const Expr *expr,
														const CMappingVarColId *var_colid_mapping)
{
	...
	CDXLNode *left_node =
		CreateScalarOpFromExpr((Expr *) gpdb::ListNth(distinct_expr->args, 0), var_colid_mapping);

	CDXLNode *right_node =
		CreateScalarOpFromExpr((Expr *) gpdb::ListNth(distinct_expr->args, 1), var_colid_mapping);

	GPOS_ASSERT(NULL != left_node);
	GPOS_ASSERT(NULL != right_node);

	CDXLScalarDistinctComp *dxlop =
		GPOS_NEW(m_mp) CDXLScalarDistinctComp(m_mp, GPOS_NEW(m_mp) CMDIdGPDB(distinct_expr->opno));
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorScalarToDXL::CreateScalarCmpFromOpExpr(const Expr *expr,
												  const CMappingVarColId *var_colid_mapping)
{
	...
	CDXLScalarComp *dxlop =
		GPOS_NEW(m_mp) CDXLScalarComp(m_mp, mdid, GPOS_NEW(m_mp) CWStringConst(str->GetBuffer()));
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorScalarToDXL::CreateScalarOpExprFromExpr(const Expr *expr,
												   const CMappingVarColId *var_colid_mapping)
{
	GPOS_ASSERT(IsA(expr, OpExpr));
	...
	CDXLScalarOpExpr *dxlop = GPOS_NEW(m_mp) CDXLScalarOpExpr(
		m_mp, mdid, return_type_mdid, GPOS_NEW(m_mp) CWStringConst(str->GetBuffer()));
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorScalarToDXL::CreateScalarNullIfFromExpr(const Expr *expr,
												   const CMappingVarColId *var_colid_mapping)
{
	...
	CDXLScalarNullIf *dxlop = GPOS_NEW(m_mp)
		CDXLScalarNullIf(m_mp,
						 GPOS_NEW(m_mp) CMDIdGPDB(null_if_expr->opno),
						 GPOS_NEW(m_mp) CMDIdGPDB(gpdb::ExprType((Node *) null_if_expr)));
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorScalarToDXL::TranslateArrayOpExpr(const Expr *expr,
											 const CMappingVarColId *var_colid_mapping)
{
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorScalarToDXL::CreateScalarArrayCompFromExpr(const Expr *expr,
													  const CMappingVarColId *var_colid_mapping)
{
	...
	CDXLScalarArrayComp *dxlop =
		GPOS_NEW(m_mp) CDXLScalarArrayComp(m_mp,
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorScalarToDXL::CreateScalarConstFromExpr(const Expr *expr,
												  const CMappingVarColId *  // var_colid_mapping
)
{
	...
	CDXLNode *dxlnode = GPOS_NEW(m_mp)
		CDXLNode(m_mp, GPOS_NEW(m_mp) CDXLScalarConstValue(m_mp, GetDatumVal(constant)));
...
//---------------------------------------------------------------------------
CDXLDatum *
CTranslatorScalarToDXL::GetDatumVal(IMemoryPool *mp, CMDAccessor *mda, const Const *constant)
{
	...
	CDXLDatum *datum_dxl = CTranslatorScalarToDXL::GetDatumVal(mp,
															   md_type,
...
//---------------------------------------------------------------------------
CDXLDatum *
CTranslatorScalarToDXL::GetDatumVal(const Const *constant) const
{
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorScalarToDXL::CreateScalarBoolExprFromExpr(const Expr *expr,
													 const CMappingVarColId *var_colid_mapping)
{
	...
	CDXLNode *dxlnode =
		GPOS_NEW(m_mp) CDXLNode(m_mp, GPOS_NEW(m_mp) CDXLScalarBoolExpr(m_mp, type));
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorScalarToDXL::CreateScalarBooleanTestFromExpr(const Expr *expr,
														const CMappingVarColId *var_colid_mapping)
{
	...
	CDXLNode *dxlnode =
		GPOS_NEW(m_mp) CDXLNode(m_mp, GPOS_NEW(m_mp) CDXLScalarBooleanTest(m_mp, type));
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorScalarToDXL::CreateScalarNullTestFromNullTest(const Expr *expr,
														 const CMappingVarColId *var_colid_mapping)
{
	...
	CDXLNode *dxlnode =
		GPOS_NEW(m_mp) CDXLNode(m_mp, GPOS_NEW(m_mp) CDXLScalarNullTest(m_mp, is_null));
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorScalarToDXL::CreateScalarCoalesceFromExpr(const Expr *expr,
													 const CMappingVarColId *var_colid_mapping)
{
	...
	CDXLScalarCoalesce *dxlop = GPOS_NEW(m_mp)
		CDXLScalarCoalesce(m_mp, GPOS_NEW(m_mp) CMDIdGPDB(coalesce_expr->coalescetype));
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorScalarToDXL::CreateScalarMinMaxFromExpr(const Expr *expr,
												   const CMappingVarColId *var_colid_mapping)
{
	...
	CDXLScalarMinMax *dxlop = GPOS_NEW(m_mp)
		CDXLScalarMinMax(m_mp, GPOS_NEW(m_mp) CMDIdGPDB(min_max_expr->minmaxtype), min_max_type);
...
//---------------------------------------------------------------------------
void
CTranslatorScalarToDXL::TranslateScalarChildren(CDXLNode *dxlnode,
												List *list,
												const CMappingVarColId *var_colid_mapping,
												BOOL *has_distributed_tables  // output
)
{
	...
	ForEach(lc, list)
	{
		...
		CDXLNode *child_node =
			CreateScalarOpFromExpr(child_expr, var_colid_mapping, has_distributed_tables);
		GPOS_ASSERT(NULL != child_node);
		dxlnode->AddChild(child_node);
	}
}
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorScalarToDXL::CreateScalarCaseStmtFromExpr(const Expr *expr,
													 const CMappingVarColId *var_colid_mapping)
{
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorScalarToDXL::CreateScalarSwitchFromCaseExpr(const CaseExpr *case_expr,
													   const CMappingVarColId *var_colid_mapping)
{
	GPOS_ASSERT(NULL != case_expr->arg);

	CDXLScalarSwitch *dxlop =
		GPOS_NEW(m_mp) CDXLScalarSwitch(m_mp, GPOS_NEW(m_mp) CMDIdGPDB(case_expr->casetype));
	...
	if (NULL != case_expr->defresult)
	{
		CDXLNode *default_result_node =
			CreateScalarOpFromExpr(case_expr->defresult, var_colid_mapping);
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorScalarToDXL::CreateScalarCaseTestFromExpr(const Expr *expr,
													 const CMappingVarColId *  //var_colid_mapping
)
{
	...
	CDXLScalarCaseTest *dxlop =
		GPOS_NEW(m_mp) CDXLScalarCaseTest(m_mp, GPOS_NEW(m_mp) CMDIdGPDB(case_test_expr->typeId));
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorScalarToDXL::CreateScalarIfStmtFromCaseExpr(const CaseExpr *case_expr,
													   const CMappingVarColId *var_colid_mapping)
{
	GPOS_ASSERT(NULL == case_expr->arg);
	...
	for (ULONG ul = 0; ul < when_clause_count; ul++)
	{
		CDXLScalarIfStmt *if_stmt_new_dxl =
			GPOS_NEW(m_mp) CDXLScalarIfStmt(m_mp, GPOS_NEW(m_mp) CMDIdGPDB(case_expr->casetype));
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorScalarToDXL::CreateScalarCastFromRelabelType(const Expr *expr,
														const CMappingVarColId *var_colid_mapping)
{
	...
	CDXLNode *dxlnode = GPOS_NEW(m_mp)
		CDXLNode(m_mp,
				 GPOS_NEW(m_mp) CDXLScalarCast(m_mp,
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorScalarToDXL::CreateScalarCoerceFromCoerce(const Expr *expr,
													 const CMappingVarColId *var_colid_mapping)
{
	...
	CDXLNode *dxlnode = GPOS_NEW(m_mp) CDXLNode(
		m_mp,
		GPOS_NEW(m_mp) CDXLScalarCoerceToDomain(m_mp,
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorScalarToDXL::CreateScalarCoerceFromCoerceViaIO(const Expr *expr,
														  const CMappingVarColId *var_colid_mapping)
{
	...
	CDXLNode *dxlnode = GPOS_NEW(m_mp)
		CDXLNode(m_mp,
				 GPOS_NEW(m_mp) CDXLScalarCoerceViaIO(m_mp,
													  GPOS_NEW(m_mp) CMDIdGPDB(coerce->resulttype),
													  -1,
	...
	const Expr *expr, const CMappingVarColId *var_colid_mapping)
{
	...
	CDXLNode *dxlnode = GPOS_NEW(m_mp) CDXLNode(
		m_mp,
		GPOS_NEW(m_mp)
			CDXLScalarArrayCoerceExpr(m_mp,
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorScalarToDXL::CreateScalarFuncExprFromFuncExpr(const Expr *expr,
														 const CMappingVarColId *var_colid_mapping)
{
	...
	CDXLNode *dxlnode = GPOS_NEW(m_mp) CDXLNode(
		m_mp,
		GPOS_NEW(m_mp) CDXLScalarFuncExpr(m_mp,
										  mdid_func,
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorScalarToDXL::CreateScalarAggrefFromAggref(const Expr *expr,
													 const CMappingVarColId *var_colid_mapping)
{
	...
	if (md_agg->IsOrdered())
	{
		...
		GPOS_RAISE(
			gpdxl::ExmaDXL, gpdxl::ExmiPlStmt2DXLConversion, GPOS_WSZ_LIT("Ordered aggregates"));
	}
	...
	CDXLScalarAggref *aggref_scalar = GPOS_NEW(m_mp)
		CDXLScalarAggref(m_mp, agg_mdid, resolved_ret_type, aggref->aggdistinct, agg_stage);
...
//---------------------------------------------------------------------------
EdxlFrameBoundary
CTranslatorScalarToDXL::Edxlfb(WindowBoundingKind kind, Node *pnode) const
{
...
//---------------------------------------------------------------------------
CDXLWindowFrame *
CTranslatorScalarToDXL::GetWindowFrame(const Expr *expr,
									   const CMappingVarColId *var_colid_mapping,
...
)
{
	...
	EdxlFrameBoundary trailing_boundary =
		Edxlfb(pwindowframe->trail->kind, pwindowframe->trail->val);
	...
	CDXLNode *lead_edge = GPOS_NEW(m_mp) CDXLNode(
		m_mp,
		GPOS_NEW(m_mp) CDXLScalarWindowFrameEdge(m_mp, true /* fLeading */, leading_boundary));
	CDXLNode *trail_edge = GPOS_NEW(m_mp) CDXLNode(
		m_mp,
		GPOS_NEW(m_mp) CDXLScalarWindowFrameEdge(m_mp, false /* fLeading */, trailing_boundary));

	// translate the lead and trail value
	if (NULL != pwindowframe->lead->val)
	{
		lead_edge->AddChild(CreateDXLNodeFromWindowFrameEdgeVal(pwindowframe->lead->val,
																var_colid_mapping,
																new_scalar_proj_list,
																has_distributed_tables));
	}

	if (NULL != pwindowframe->trail->val)
	{
		trail_edge->AddChild(CreateDXLNodeFromWindowFrameEdgeVal(pwindowframe->trail->val,
																 var_colid_mapping,
																 new_scalar_proj_list,
																 has_distributed_tables));
	}
	...
	CDXLWindowFrame *window_frame_dxl =
		GPOS_NEW(m_mp) CDXLWindowFrame(m_mp, frame_spec, strategy, lead_edge, trail_edge);
...
{
	CDXLNode *val_node =
		CreateScalarOpFromExpr((Expr *) node, var_colid_mapping, has_distributed_tables);
	...
	if (m_is_query_mode && !IsA(node, Var) && !IsA(node, Const))
	{
		...
		CDXLNode *project_element_node = GPOS_NEW(m_mp) CDXLNode(
			m_mp, GPOS_NEW(m_mp) CDXLScalarProjElem(m_mp, project_element_id, alias_mdname));
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorScalarToDXL::PdxlnScWindowref(const Expr *expr,
										 const CMappingVarColId *var_colid_mapping)
{
	...
	if (WINDOW_PERCENT_RANK == pwindowref->winfnoid)
	{
		GPOS_RAISE(gpdxl::ExmaDXL,
				   gpdxl::ExmiQuery2DXLUnsupportedFeature,
				   GPOS_WSZ_LIT("PERCENT_RANK Window Functions"));
	}
	else if (CUME_DIST_OID == pwindowref->winfnoid)
	{
		GPOS_RAISE(gpdxl::ExmaDXL,
				   gpdxl::ExmiQuery2DXLUnsupportedFeature,
				   GPOS_WSZ_LIT("CUME_DIST Window Functions"));
	}
			 ...
			 WINDOW_NTILE_NUMERIC == pwindowref->winfnoid)
	{
		GPOS_RAISE(gpdxl::ExmaDXL,
				   gpdxl::ExmiQuery2DXLUnsupportedFeature,
				   GPOS_WSZ_LIT("NTILE Window Functions"));
	}

	CDXLScalarWindowRef *winref_dxlop =
		GPOS_NEW(m_mp) CDXLScalarWindowRef(m_mp,
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorScalarToDXL::CreateScalarCondFromQual(List *quals,
												 const CMappingVarColId *var_colid_mapping,
												 BOOL *has_distributed_tables)
{
	...
	else
	{
		...
		CDXLNode *dxlnode =
			GPOS_NEW(m_mp) CDXLNode(m_mp, GPOS_NEW(m_mp) CDXLScalarBoolExpr(m_mp, Edxland));
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorScalarToDXL::CreateFilterFromQual(List *quals,
											 const CMappingVarColId *var_colid_mapping,
...
)
{
	...
	CDXLNode *cond_node =
		CreateScalarCondFromQual(quals, var_colid_mapping, has_distributed_tables);
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorScalarToDXL::CreateDXLNodeFromSublink(const Expr *expr,
												 const CMappingVarColId *var_colid_mapping)
{
	...
	const SubLink *sublink, const CMappingVarColId *var_colid_mapping)
{
	...
	query_to_dxl_translator =
		CTranslatorQueryToDXL::QueryToDXLInstance(m_mp,
												  m_md_accessor,
												  m_colid_generator,
												  m_cte_id_generator,
												  var_colid_map_copy,
	...
	{
		subquery = GPOS_NEW(m_mp)
			CDXLScalarSubqueryAll(m_mp, mdid, GPOS_NEW(m_mp) CMDName(m_mp, str), colid);
	}
	else
	{
		subquery = GPOS_NEW(m_mp)
			CDXLScalarSubqueryAny(m_mp, mdid, GPOS_NEW(m_mp) CMDName(m_mp, str), colid);
	}
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorScalarToDXL::CreateScalarSubqueryFromSublink(const SubLink *sublink,
														const CMappingVarColId *var_colid_mapping)
{
	CMappingVarColId *var_colid_map_copy = var_colid_mapping->CopyMapColId(m_mp);
	...
	CAutoP<CTranslatorQueryToDXL> query_to_dxl_translator;
	query_to_dxl_translator = CTranslatorQueryToDXL::QueryToDXLInstance(m_mp,
																		m_md_accessor,
																		m_colid_generator,
																		m_cte_id_generator,
																		var_colid_map_copy,
	...
	CDXLNode *dxlnode =
		GPOS_NEW(m_mp) CDXLNode(m_mp, GPOS_NEW(m_mp) CDXLScalarSubquery(m_mp, colid));
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorScalarToDXL::TranslateArray(const Expr *expr, const CMappingVarColId *var_colid_mapping)
{
	...
	CDXLScalarArray *dxlop =
		GPOS_NEW(m_mp) CDXLScalarArray(m_mp,
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorScalarToDXL::TranslateArrayRef(const Expr *expr,
										  const CMappingVarColId *var_colid_mapping)
{
	...
	CDXLScalarArrayRef *dxlop =
		GPOS_NEW(m_mp) CDXLScalarArrayRef(m_mp,
	...
	// add children
	AddArrayIndexList(dxlnode,
					  parrayref->reflowerindexpr,
					  CDXLScalarArrayRefIndexList::EilbLower,
					  var_colid_mapping);
	AddArrayIndexList(dxlnode,
					  parrayref->refupperindexpr,
	...
	const CMappingVarColId *var_colid_mapping)
{
	...
	CDXLNode *index_list_dxlnode = GPOS_NEW(m_mp)
		CDXLNode(m_mp, GPOS_NEW(m_mp) CDXLScalarArrayRefIndexList(m_mp, index_list_bound));
...
//---------------------------------------------------------------------------
CDXLNode *
CTranslatorScalarToDXL::CreateExistSubqueryFromSublink(const SubLink *sublink,
													   const CMappingVarColId *var_colid_mapping)
{
	...
	CDXLNode *dxlnode =
		GPOS_NEW(m_mp) CDXLNode(m_mp, GPOS_NEW(m_mp) CDXLScalarSubqueryExists(m_mp));
...
//---------------------------------------------------------------------------
CDXLDatum *
CTranslatorScalarToDXL::GetDatumVal(IMemoryPool *mp,
...
//---------------------------------------------------------------------------
CDXLDatum *
CTranslatorScalarToDXL::CreateGenericCDXLDatum(IMemoryPool *mp,
											   const IMDType *md_type,
											   INT type_modifier,
											   BOOL is_null,
											   ULONG len,
											   Datum datum)
{
	...
	return CMDTypeGenericGPDB::CreateDXLDatumVal(
		mp, mdid, type_modifier, is_const_by_val, is_null, bytes, length, lint_value, double_value);
}
...
//---------------------------------------------------------------------------
CDXLDatum *
CTranslatorScalarToDXL::CreateBoolCDXLDatum(IMemoryPool *mp,
											const IMDType *md_type,
											BOOL is_null,
											ULONG,  //len,
											Datum datum)
...
//---------------------------------------------------------------------------
CDXLDatum *
CTranslatorScalarToDXL::CreateOidCDXLDatum(IMemoryPool *mp,
										   const IMDType *md_type,
										   BOOL is_null,
										   ULONG,  //len,
										   Datum datum)
...
//---------------------------------------------------------------------------
CDXLDatum *
CTranslatorScalarToDXL::PdxldatumInt2(IMemoryPool *mp,
									  const IMDType *md_type,
									  BOOL is_null,
									  ULONG,  //len,
									  Datum datum)
...
//---------------------------------------------------------------------------
CDXLDatum *
CTranslatorScalarToDXL::PdxldatumInt4(IMemoryPool *mp,
									  const IMDType *md_type,
									  BOOL is_null,
									  ULONG,  //len,
									  Datum datum)
...
//---------------------------------------------------------------------------
CDXLDatum *
CTranslatorScalarToDXL::PdxldatumInt8(IMemoryPool *mp,
									  const IMDType *md_type,
									  BOOL is_null,
									  ULONG,  //len,
									  Datum datum)
...
//---------------------------------------------------------------------------
CDouble
CTranslatorScalarToDXL::GetDoubleValue(IMDId *mdid, BOOL is_null, BYTE *bytes, Datum datum)
{
...
BYTE *
CTranslatorScalarToDXL::GetByteArray(
	IMemoryPool *mp, const IMDType *md_type, BOOL is_null, ULONG len, Datum datum)
{
	ULONG length = 0;
	BYTE *bytes = NULL;
...
//---------------------------------------------------------------------------
LINT
CTranslatorScalarToDXL::GetLintValue(IMDId *mdid, BOOL is_null, BYTE *bytes, ULONG length)
{
...
//---------------------------------------------------------------------------
IDatum *
CTranslatorScalarToDXL::GetDatum(IMemoryPool *mp,
								 const IMDType *md_type,
								 BOOL is_null,
								 Datum gpdb_datum)
{
	...
	CDXLDatum *datum_dxl = CTranslatorScalarToDXL::GetDatumVal(
