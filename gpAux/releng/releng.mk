...
ifeq "$(findstring aix,$(BLD_ARCH))" ""
	LD_LIBRARY_PATH='' wget --no-check-certificate -q -O - https://github.com/khannaekta/gporca/releases/download/v2.64.0/bin_orca_centos5_release.tar.gz | tar zxf - -C $(BLD_TOP)/ext/$(BLD_ARCH)
endif
